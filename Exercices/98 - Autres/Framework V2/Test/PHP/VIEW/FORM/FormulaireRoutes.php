<?php
            $infosTable = RecupInfos("Routes");
            $listeCleSecondaires = ListerFK("Routes");
    ...
    $form .='<input type="hidden" id="Mode" name="Mode" value='.$_GET["Mode"].'></input>';
        ...
        $form .= '<div>&nbsp;</div>';
        $form .= '<div>&nbsp;</div>';
        $form .= '<a href=".?afficher=ListeRoutes"><input id="btnCancel" class="cancel" type="button" value="Annuler"/></a>';
