<?php
    ...
    $totalEntrees = count(ClassesManager::GetList(null, null, null, null, false, false));
    ...
    <div class="ligne">
        <div></div>
        <div class="centered"><a href=".?afficher=FormClasses" class="buttonDash">Ajouter</a></div>
        <div></div>
    </div>
    <div class="ligne">    
