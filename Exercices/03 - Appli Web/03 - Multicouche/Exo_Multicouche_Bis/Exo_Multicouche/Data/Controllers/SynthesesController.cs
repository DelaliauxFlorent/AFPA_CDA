...
namespace Exo_Multicouche.Data.Controllers
{
    ...
    public class SynthesesController : ControllerBase
    {
        ...
        public SynthesesController(SynthesesServices service, IMapper mapper, McContext context)
        {
            _service = service;
            _mapper = mapper;
            _context = context;
        ...
        {
            VotesServices voteService = new VotesServices(_context);
            voteService.MajResultat();
