...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `exemple` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `employe` (
  ...
  PRIMARY KEY (`noemp`),
  KEY `FK_employe_dept` (`nodep`),
  CONSTRAINT `FK_employe_dept` FOREIGN KEY (`nodep`) REFERENCES `dept` (`nodept`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
