...
--
-- Host: localhost    Database: stagiaires_afpa
-- ------------------------------------------------------
...
--
-- Current Database: `stagiaires_afpa`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `stagiaires_afpa` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `animations` (
  ...
  KEY `FK_Animations_Formateurs` (`idFormateur`),
...
INSERT INTO `constitutions` VALUES (1,1,1),(2,3,1),(3,2,2),(4,1,2),(5,3,3),(6,2,3),(7,1,4),(8,2,4),(9,2,5),(10,3,5);
...
INSERT INTO `stagiaires` VALUES (1,'roblin','lea','12,bd de la liberte','calais',62100,'21345678','2014-09-01','F','1995-01-14',5,2,2),(2,'macarthur','leon','121,bd gambetta','calais',62100,'21-30-65-09','2014-09-01','M','1994-04-12',3,1,2),(3,'minol','luc','9,rue des prairies','boulogne',62200,'21-30-20-10','2014-09-01','M','1997-03-12',2,2,2),(4,'minol','sophie','12,rue des capucines','wimereux',62930,'21-89-04-30','2014-09-01','F','1996-03-21',5,4,2),(5,'minol','marc','67,allee ronde','marcq',62300,'21-90-87-65','2014-09-01','M','1993-02-05',3,1,2),(6,'vendraux','marc','5,rue de marseille','calais',62100,'21-96-00-09','2013-09-01','M','1996-01-21',4,1,2),(7,'vendermaele','helene','456,rue de paris','boulogne',62200,'21-45-45-60','2014-09-01','F','1995-03-30',5,2,2),(8,'besson','loic','3,allee carpentier','dunkerque',59300,'28-90-89-78','2014-09-01','M','1994-05-21',1,3,1),(9,'godart','jean-paul','123,rue de lens','marck',59870,'28-09-87-65','2013-09-01','M','1993-01-12',1,3,1),(10,'beaux','marie','1,allee des cygnes','dunkerque',59100,'21-30-87-90','2014-09-01','F','1996-04-12',2,2,2),(11,'turini','elsa','12,route de paris','boulogne',62200,'21-32-47-97','2014-09-01','F','1996-07-17',1,3,2),(12,'torelle','elise','123,vallee du denacre','boulogne',62200,'21-67-86-90','2014-09-01','F','1997-04-16',3,1,1),(13,'pharis','pierre','12,avenue foch','calais',62100,'21-21-85-90','2014-09-01','M','1996-03-18',4,1,1),(14,'ephyre','luc','12,rue de lyon','calais',62100,'21-35-32-90','2014-09-01','M','1995-01-21',3,4,1),(15,'leclercq','jules','12,allee des ravins','boulogne',62200,'21-36-71-92','2014-09-01','M','1994-05-19',3,1,2),(16,'dupont','luc','21,avenue monsigny','calais',62200,'21-21-34-99','2014-09-01','M','1996-11-02',2,2,2),(17,'marke','loic','312,route de paris','wimereux',62930,'21-87-87-71','2014-09-01','M','1996-11-12',5,4,1),(18,'dewa','leon','121,allee des eglantines','dunkerque',59100,'28-30-87-90','2014-09-01','M','1997-04-03',2,4,1);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `suivis` (
  `idSuivis` int(11) NOT NULL AUTO_INCREMENT,
  `idStagiaire` int(11) DEFAULT NULL,
  `idMatiere` int(11) DEFAULT NULL,
  `note` float DEFAULT NULL,
  PRIMARY KEY (`idSuivis`),
...
INSERT INTO `suivis` VALUES (1,1,2,10),(2,1,3,19),(3,11,1,12),(4,12,3,14),(5,3,1,12),(6,15,2,3),(7,8,1,8),(8,16,2,4),(9,14,3,7),(10,9,1,1);
